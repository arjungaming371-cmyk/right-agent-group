...
-- ============================================================
-- 2026-09-18 / 19 / 20 PARITY BLOCK
-- These existed only as migrations, so fresh `db:setup` installs
-- were missing tables the app queries at runtime (Instagram view,
-- API-keys admin, module allotment, dialer claim safety).
-- ============================================================

-- Module allotment (2026-09-18_module_allotment)
ALTER TABLE allowed_emails ADD COLUMN IF NOT EXISTS allowed_modules TEXT[] DEFAULT NULL;

-- Website-managed system API keys + token usage logging (2026-09-19_system_api_keys)
...
-- Instagram DMs + Post Comments (2026-09-19_instagram_messages)
